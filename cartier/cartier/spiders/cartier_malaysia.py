...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    name = 'Cartier_Malaysia'
    headers = {
        'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/106.0.0.0 Safari/537.36", 'Accept-Language': 'en'}

    start_urls = ['https://www.cartier.com/en-my/home']
    site = 'https://www.cartier.com'
    execution_id = '621291'
    feed_code = 'aeid5482'
    record_create_by = 'aeid5482_cartier_Malaysia'
    ...
    def parse(self, response):  # fetching all the href present in the site
        ...
        a = ['/en-my/jewellery/collections/','/en-my/jewellery/bracelets/', '/en-my/jewellery/rings/',
             '/en-my/jewellery/necklaces/', '/en-my/jewellery/earrings/', '/en-my/jewellery/engagement-rings/',
             '/en-my/jewellery/wedding-bands/', '/en-my/watches/collections/',
             '/en-my/art-of-living/bags/', '/en-my/art-of-living/personal-accessories/', '/en-my/art-of-living/home/',
             '/en-my/art-of-living/writing-%26-stationery/', '/en-my/art-of-living/eyewear/',
             '/en-my/art-of-living/fragrances/'
             ]
