...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    name = 'Cartier_SaudiArabia'
    headers = {
        'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/106.0.0.0 Safari/537.36", 'Accept-Language': 'en'}

    start_urls = ['https://www.cartier.com/en-sa/home']
    site = 'https://www.cartier.com'
    execution_id = '621291'
    feed_code = 'aeid5482'
    record_create_by = 'aeid5482_cartier_SaudiArabia'
    record_create_date = datetime.now()
    source_country = 'SaudiArabia'
    ...
    def parse(self, response):  # fetching all the href present in the site
        ...
        a = ['/en-sa/jewellery/collections/','/en-sa/jewellery/bracelets/', '/en-sa/jewellery/rings/',
             '/en-sa/jewellery/necklaces/','/en-sa/jewellery/earrings/','/en-sa/jewellery/engagement-rings/',
             '/en-sa/jewellery/wedding-bands/','/en-sa/watches/collections/',
             '/en-sa/watches/tank-must-online-exclusive/','/en-sa/art-of-living/bags/',
             '/en-sa/art-of-living/personal-accessories/','/en-sa/art-of-living/home/',
             '/en-sa/art-of-living/writing-%26-stationery/','/en-sa/art-of-living/eyewear/',
             'https://www.cartier.com/en-sa/art-of-living/fragrances/womens-fragrances/',
             'https://www.cartier.com/en-sa/art-of-living/fragrances/mens-fragrances/',
             'https://www.cartier.com/en-sa/art-of-living/fragrances/fragrance-gift-sets/',
             'https://www.cartier.com/en-sa/art-of-living/fragrances/high-perfumery/']

        for j in attributes:
            for k in a:
                k = k.replace('https://www.cartier.com', '')
                if k in j:
                    attr = self.site + j
