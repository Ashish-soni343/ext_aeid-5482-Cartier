...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    ...
    start_urls = ['https://www.cartier.com/en-ae/home']
    site = 'https://www.cartier.com'
    execution_id = '621291'
    feed_code = 'aeid5482'
    record_create_by = 'aeid5482_cartier_UAE'
    ...
    def parse(self, response):  # fetching all the href present in the site
        ...
        a= ['/en-ae/jewellery/collections/', '/en-ae/jewellery/bracelets/', '/en-ae/jewellery/rings/',
             '/en-ae/jewellery/necklaces/', '/en-ae/jewellery/earrings/', '/en-ae/jewellery/engagement-rings/',
             '/en-ae/jewellery/wedding-bands/', '/en-ae/watches/collections/',
             '/en-ae/art-of-living/bags/', '/en-ae/art-of-living/personal-accessories/', '/en-ae/art-of-living/home/',
             '/en-ae/art-of-living/writing-%26-stationery/', '/en-ae/art-of-living/eyewear/',
             '/en-ae/fragrances/womens-fragrances/', '/en-ae/fragrances/mens-fragrances/',
             '/en-ae/fragrances/fragrance-gift-sets/','/en-ae/fragrances/high-perfumery/']
        for j in attributes:
            for k in a:
                if k in j:
                    attr = self.site + j
