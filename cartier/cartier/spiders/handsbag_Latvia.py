...
class ExampleSpider(scrapy.Spider):
    name = 'cartier_handbags_LT'

    start_urls = ['https://int.cartier.com/en/collections/accessories/leather-goods.viewall.html']
    headers = {
