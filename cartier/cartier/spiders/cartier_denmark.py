...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    name = 'Cartier_Denmark'
    headers = {
        'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/106.0.0.0 Safari/537.36", 'Accept-Language': 'en'}

    start_urls = ['https://www.cartier.com/en-dk/jewellery','https://www.cartier.com/en-dk/watches','https://www.cartier.com/en-dk/bags','https://www.cartier.com/en-dk/accessories',
            'https://www.cartier.com/en-dk/art-of-living-home','https://www.cartier.com/en-at/writing-and-stationery',
            'https://www.cartier.com/en-dk/eyewear','https://www.cartier.com/en-dk/fragrances']
