...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    name = 'Cartier_CzechRepublic'
    headers = {
        'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/106.0.0.0 Safari/537.36", 'Accept-Language': 'en'}

    start_urls = ['https://www.cartier.com/en-cz/jewellery','https://www.cartier.com/en-ch/watches','https://www.cartier.com/en-cz/bags','https://www.cartier.com/en-cz/accessories',
            'https://www.cartier.com/en-cz/art-of-living-home','https://www.cartier.com/en-cz/writing-and-stationery',
            'https://www.cartier.com/en-cz/eyewear','https://www.cartier.com/en-cz/fragrances']
    site = 'https://www.cartier.com'
    execution_id = '621291'
    feed_code = 'aeid5482'
    record_create_by = 'aeid5482_cartier'
    record_create_date = datetime.now()
    source_country = 'CzechRepublic'
