...
class ProSpider(scrapy.Spider):  # class to initiate spider with required values
    name = 'Cartier_Belgium'
    headers = {
        'User-Agent': "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) "
                      "Chrome/106.0.0.0 Safari/537.36", 'Accept-Language': 'en'}

    start_urls = ['https://www.cartier.com/en-be/jewellery','https://www.cartier.com/en-be/watches','https://www.cartier.com/en-be/bags','https://www.cartier.com/en-be/accessories',
            'https://www.cartier.com/en-be/art-of-living-home','https://www.cartier.com/en-be/writing-and-stationery',
            'https://www.cartier.com/en-be/eyewear','https://www.cartier.com/en-be/fragrances']
